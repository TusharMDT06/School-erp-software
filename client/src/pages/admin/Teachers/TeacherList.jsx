...
import {
  ...
  Pencil, UserX, UserCheck, BadgeCheck, Mail,
} from "lucide-react";
import { fetchTeachers, deleteTeacher } from "../../../features/teacher/teacherSlice";
...
const TeacherList = () => {
  ...
  const handleDeactivate = async (id) => {
    const res = await dispatch(deleteTeacher(id));
                    ...
                    <tr key={t._id} className="hover:bg-slate-50/60 transition-colors">
                      ...
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-2">
                          ...
                          <button
                            onClick={() => setConfirmDeactivate(t._id)}
      ...
      {confirmDeactivate && (
        <div className="fixed inset-0 bg-black/40 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-sm p-6">
            <h3 className="text-base font-semibold text-slate-800 mb-2">Deactivate Teacher?</h3>
            <p className="text-sm text-slate-500 mb-5">
              The teacher's account will be disabled. This can be re-enabled later.
            </p>
